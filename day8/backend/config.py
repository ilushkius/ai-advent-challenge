...
1. файл `.env` в папке дня 8 (day8/backend/config.py -> ../.env);
...
# Персистентное хранилище дня 8: SQLite-файл в папке дня (day8/agents.db).
...
# Путь к .env дня 8: этот файл лежит в day8/backend/, значит .env — в day8/.
...
def resolve_api_key():
    """Возвращает ключ DeepSeek: day8/.env → переменная окружения → None."""
