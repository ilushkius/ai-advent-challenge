"""Пакет backend дня 15: агенты DeepSeek с памятью, задачей, инвариантами и переходами.

День 15 развивает день 14: к слоям памяти, стратегиям управления контекстом,
...
# Корень репозитория (day15/backend/__init__.py -> корень проекта): из него
