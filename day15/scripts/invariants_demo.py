"""Прогон трёх сценариев инвариантов и отчёт ``day15/invariants_demo.md``.
...
# Скрипты лежат в day15/scripts/, а пакет backend — в корне дня: добавляем корень
...
def build_report(results: list) -> str:
    ...
    chunks = [
        ...
        "(из папки `day15/`). Правила в рабочую БД для интерфейса сеет "
