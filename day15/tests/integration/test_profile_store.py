"""Тесты хранилища профилей (день 13, ``backend/profile_store.py``).
...
from backend.agents.profile_store import (
...
def test_invalid_preferences_rejected_before_write(store):
    ...
    from backend.domain.profiles import ProfileValueError
