"""Пакет backend дня 17: агенты DeepSeek с памятью, задачей, инвариантами и переходами.

День 17 развивает день 14: к слоям памяти, стратегиям управления контекстом,
...
# Корень репозитория (day19/backend/__init__.py -> корень проекта): из него
