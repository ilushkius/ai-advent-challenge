"""Раздел «💬 Чат и память» дня 19: карточка агента, панели, диалог и ввод.
...
from . import (
    ...
    memory_panels, notifications, pipeline_section, profile_section,
...
def render_main_area() -> None:
    ...
    if not st.session_state["backend_ok"]:
        st.warning("🔌 Бэкенд недоступен. Запустите его из папки day19/:")
