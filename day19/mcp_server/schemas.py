...
class SearchResult(TypedDict):
    """Результат поиска: запрос, источник, вид источника, число элементов и сами элементы."""

    query: str
    source: str
    source_kind: str          # "api" | "file" | "sqlite"
    count: int
...
class SavedFile(TypedDict):
    """Сохранённый файл: имя, путь, размер, формат и момент записи."""
