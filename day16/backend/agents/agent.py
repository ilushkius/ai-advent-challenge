"""Класс Agent дня 16 — агент с памятью, задачей, инвариантами и переходами.

День 16 добавляет **контролируемые переходы** состояния задачи: состояние
...
class Agent:
    ...
    def _make_client(self):
        ...
        if not api_key:
            raise AgentError(
                "Ключ API не задан: укажите DEEPSEEK_API_KEY в файле day16/.env "
