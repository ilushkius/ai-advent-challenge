"""Доменный слой дня 16: чистые правила и данные, без БД, LLM и транспорта.
...
- ``mcp_tools`` — структура инструмента MCP: имя, описание, схема аргументов.
...
from .mcp_tools import MCPToolError, MCPToolInfo, make_tool_info, make_tool_infos
