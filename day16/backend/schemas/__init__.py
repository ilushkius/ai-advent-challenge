"""Pydantic-схемы API дня 16: единое место моделей, разложенное по доменам.
...
- ``mcp.py``     — MCP-подключение дня 16: статус, инструменты (name,
  description, input_schema) и их количество;
