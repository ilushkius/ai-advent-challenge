...
from .models import (
    ...
    GenerateResponse, MessageOut, StrategiesOut, StrategySetRequest,
    SummarizeRequest, SummaryInfo, UsageOut, UsageSummary,
)
...
app = FastAPI(
    title="Агенты DeepSeek со стратегиями контекста — День 10",
    description=(
        "FastAPI-бэкенд веб-приложения: каждый агент ведёт диалог в SQLite "
        "(таблицы agents, messages, summaries, token_usage, facts, checkpoints) "
        "и собирает контекст для DeepSeek одной из четырёх стратегий: "
