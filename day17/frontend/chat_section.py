"""Раздел «💬 Чат и память» дня 17: карточка агента, панели, диалог и ввод.
...
разделов (чат, профиль, состояние задачи, инварианты, MCP), карточка активного
...
from . import (
    ...
    memory_panels, profile_section, task_panel,
)
...
def render_main_area() -> None:
    ...
    if not st.session_state["backend_ok"]:
        st.warning("🔌 Бэкенд недоступен. Запустите его из папки day17/:")
