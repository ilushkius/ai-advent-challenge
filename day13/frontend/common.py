"""Общие помощники интерфейса дня 13 (наследовано из дня 12): подписи, форматтеры и состояние страницы.

Здесь живут словари человекочитаемых подписей (роли, стратегии, категории
долговременной памяти, слои памяти, состояния стейт-машины сжатия), форматтеры
значений и всё, что связано с ``st.session_state``: инициализация состояния,
одноразовое флеш-сообщение, загрузка списка агентов и выбор активного.
"""
import html
