"""Раздел «💬 Чат и память» дня 13: карточка агента, панели, диалог и ввод.
...
разделов (чат, профиль, состояние задачи), карточка активного агента, панели
стратегии и слоёв памяти, диалог, сравнение режимов, форма ввода и очистка
истории.
"""
import streamlit as st

from . import (
    api_client, common, context_panels, memory_panels, profile_section, task_panel,
)
...
def render_main_area() -> None:
    ...
    if not st.session_state["backend_ok"]:
        st.warning("🔌 Бэкенд недоступен. Запустите его из папки day13/:")
