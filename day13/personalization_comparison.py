...
1. Создаёт отдельную БД ``day13/personalization_demo.db`` (файл удаляется и
...
from backend.demo_profiles import DEMO_FEATURE_REQUEST, DEMO_QUESTION
from comparison_report import build_report, observations
from comparison_stub import (
    COMPARISON_USERS, HERE, ORCHESTRATOR_USER, ROLE_ORDER, ask, ensure_profiles,
    prepare_manager, role_order,
)
