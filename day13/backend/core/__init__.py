"""Слой конфигурации и зависимостей дня 13.
...
from . import config
from .dependencies import agent_or_404, get_manager, task_or_404

__all__ = ["config", "get_manager", "agent_or_404", "task_or_404"]
