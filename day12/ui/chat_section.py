"""Раздел «💬 Чат и память» дня 12: карточка агента, панели, диалог и ввод.
...
разделов, карточка активного агента, панели стратегии и слоёв памяти, диалог,
сравнение режимов, форма ввода и очистка истории.
"""
import streamlit as st

from . import api_client, common, context_panels, memory_panels, profile_section
