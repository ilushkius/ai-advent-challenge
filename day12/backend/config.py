"""Конфигурация бэкенда дня 12: DeepSeek, дефолты агентов, стратегии, память, профиль.
...
1. файл `.env` в папке дня (day12/backend/config.py -> day12/.env);
...
# Персистентное хранилище дня 12: SQLite-файл в папке дня (day12/agents.db).
...
# Путь к .env дня 12: этот файл лежит в day12/backend/, значит .env — в day12/.
...
def resolve_api_key():
    """Возвращает ключ DeepSeek: day12/.env → переменная окружения → None."""
