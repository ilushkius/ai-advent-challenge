...
# ---------------------------------------------------------------------------
# read_key_from_env_file(), parse_stop_sequences() и usage_to_dict() импортированы
# из shared/deepseek_utils.py (см. шапку файла).
...
# usage_to_dict() импортирована из shared/deepseek_utils.py.
