...
class MCPUnknownServerError(MCPError):
    """Обращение к серверу, которого нет в конфигурации флота."""


class MCPUnknownToolError(MCPError):
    """Обращение к инструменту, которого нет ни у одного сервера флота."""
...
ACTION_LABELS = {
    ...
    "fleet": "Не удалось обратиться к флоту MCP-серверов",
}
