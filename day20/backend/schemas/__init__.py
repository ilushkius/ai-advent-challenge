...
- ``mcp.py``     — MCP дня 17: статус подключения, инструменты (name,
  description, input_schema, output_schema) и их вызов;
- ``mcp_servers.py`` — флот серверов дня 20: состав, состояние, инструменты
  сервера и результат обновления кэша;
