"""Прогон трёх сценариев инвариантов и отчёт ``day14/invariants_demo.md``.
...
# Скрипты лежат в day14/scripts/, а пакет backend — в корне дня: добавляем корень
...
def build_report(results: list) -> str:
    ...
    chunks = [
        "# Инварианты агента: три сценария (день 14)",
        "",
        ...
        "(из папки `day14/`). Правила в рабочую БД для интерфейса сеет "
