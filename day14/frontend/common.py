"""Общие помощники интерфейса дня 14 (наследовано из дня 12): подписи, форматтеры и состояние страницы.

Здесь живут словари человекочитаемых подписей (роли, стратегии, категории
долговременной памяти, слои памяти, состояния стейт-машины сжатия, состояния
задачи и инварианты дня 14), форматтеры значений и всё, что связано с
``st.session_state``: инициализация состояния, одноразовое флеш-сообщение,
загрузка списка агентов и выбор активного.
"""
import html
