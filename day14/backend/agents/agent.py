"""Класс Agent дня 14 — агент с памятью, контролем токенов, профилем и инвариантами.
...
class Agent:
    ...
    def _make_client(self):
        ...
        if not api_key:
            raise AgentError(
                "Ключ API не задан: укажите DEEPSEEK_API_KEY в файле day14/.env "
    ...
    def _system_message(self, summary_text: str = "",
        ...
        продолжать, и она должна читаться сразу после общей рамки. Все блоки
        вкладываются в существующее system-сообщение, а не добавляются
