"""Инструменты планировщика на настоящем stdio (день 18).
...
#: Шесть инструментов сервера дня: три читают данные, три планируют работу.
...
def test_catalog_lists_six_tools(client):
    """Каталог — шесть инструментов дня, у каждого описаны параметры."""
    client.connect()
