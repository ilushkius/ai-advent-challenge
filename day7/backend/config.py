...
1. файл `.env` в папке дня 7 (day7/backend/config.py -> ../.env);
...
# Персистентное хранилище дня 7: SQLite-файл в папке дня (day7/agents.db).
...
# Путь к .env дня 7: этот файл лежит в day7/backend/, значит .env — в day7/.
...
def resolve_api_key():
    """Возвращает ключ DeepSeek: day7/.env → переменная окружения → None."""
